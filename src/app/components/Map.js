...
class Map extends React.Component{
    ...
    render() {
        ...
        return (
            <div>
                <MyMapComponent  googleMapURL="https://maps.googleapis.com/maps/api/js?key=AIzaSyAuHu6uhb9F2sLYrup2eydm_rwxKloUYEU"
                                 loadingElement={<div style={{ height: `100%` }} />}
                                 containerElement={<div style={{ height: `100vh` }} />}
                                 mapElement={<div style={{ height: `100%` }} />}
                />
                <EventDetailDialog showDialog={this.state.showDialog}
